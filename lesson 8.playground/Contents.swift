...
let vertiсal = ["a", "b", "c", "d", "e", "f", "g", "h"]
let horizontal = ["1", "2", "3", "4", "5", "6", "7", "8"]
var board: [String:Bool] = [:]
for valueGorizontal in horizontal {
    for valueVertikal in vertiсal {
